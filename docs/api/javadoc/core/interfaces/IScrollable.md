...
**Source:** `org/rusherhack/api/javadoc/core/interfaces/IScrollable.java`
...
`IScrollable` is a interface that extends [IHoverable](/api/javadoc/core/interfaces/IHoverable.md).
