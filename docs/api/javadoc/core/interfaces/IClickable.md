...
**Source:** `org/rusherhack/api/javadoc/core/interfaces/IClickable.java`

## Overview

`IClickable` is a interface that extends [IHoverable](/api/javadoc/core/interfaces/IHoverable.md).
