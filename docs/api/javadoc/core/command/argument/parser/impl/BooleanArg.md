...
**Source:** `org/rusherhack/api/javadoc/core/command/argument/parser/impl/BooleanArg.java`
...
`BooleanArg` is a class and implements [IArg](/api/javadoc/core/command/argument/parser/IArg.md).
