...
**Source:** `org/rusherhack/api/javadoc/core/command/argument/parser/impl/ColorArg.java`
...
`ColorArg` is a class and implements [IArg](/api/javadoc/core/command/argument/parser/IArg.md).
...
```java
public Color parse(CommandProcessingSink context, String arg)
```
