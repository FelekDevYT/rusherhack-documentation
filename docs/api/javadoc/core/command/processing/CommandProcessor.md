...
**Source:** `org/rusherhack/api/javadoc/core/command/processing/CommandProcessor.java`
...
`CommandProcessor` is a class and implements [ICommandProcessor](/api/javadoc/core/command/processing/ICommandProcessor.md).
...
**Returns:** [IArg](/api/javadoc/core/command/argument/parser/IArg.md)&lt;`?`&gt;
