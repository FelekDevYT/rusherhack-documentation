...
**Source:** `org/rusherhack/api/javadoc/core/command/exceptions/BadSyntaxException.java`
...
`BadSyntaxException` is a class that extends [CommandException](/api/javadoc/core/command/exceptions/CommandException.md).
