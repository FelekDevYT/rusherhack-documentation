...
**Source:** `org/rusherhack/api/javadoc/core/setting/ListSetting.java`
...
`ListSetting` is a class that extends [Setting](/api/javadoc/core/setting/Setting.md) and implements [Iterable](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Iterable.html).
...
**Returns:** [ListHolder](/api/javadoc/core/setting/ListHolder.md)&lt;`T`&gt;
...
**Returns:** [ListSetting](/api/javadoc/core/setting/ListSetting.md)&lt;`T`&gt;
