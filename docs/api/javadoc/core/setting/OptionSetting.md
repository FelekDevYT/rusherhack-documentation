...
**Source:** `org/rusherhack/api/javadoc/core/setting/OptionSetting.java`

Like [EnumSetting](/api/javadoc/core/setting/EnumSetting.md) but better
...
`OptionSetting` is a class that extends [Setting](/api/javadoc/core/setting/Setting.md).
...
**Returns:** [OptionSetting](/api/javadoc/core/setting/OptionSetting.md)&lt;`T`&gt;
