...
**Source:** `org/rusherhack/api/javadoc/core/setting/NumberSetting.java`
...
`NumberSetting` is a class that extends [Setting](/api/javadoc/core/setting/Setting.md).
...
**Returns:** [NumberSetting](/api/javadoc/core/setting/NumberSetting.md)&lt;`T`&gt;
