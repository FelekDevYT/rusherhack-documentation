...
**Source:** `org/rusherhack/api/javadoc/core/setting/StringSetting.java`
...
`StringSetting` is a class that extends [Setting](/api/javadoc/core/setting/Setting.md).
...
**Returns:** [StringSetting](/api/javadoc/core/setting/StringSetting.md)
