...
**Source:** `org/rusherhack/api/javadoc/core/setting/NullSetting.java`
...
`NullSetting` is a class that extends [Setting](/api/javadoc/core/setting/Setting.md).
...
**Returns:** [NullSetting](/api/javadoc/core/setting/NullSetting.md)
