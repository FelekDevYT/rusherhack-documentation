...
**Source:** `org/rusherhack/api/javadoc/core/setting/EnumSetting.java`
...
`EnumSetting` is a class that extends [Setting](/api/javadoc/core/setting/Setting.md).
...
**Returns:** [EnumSetting](/api/javadoc/core/setting/EnumSetting.md)&lt;`T`&gt;
