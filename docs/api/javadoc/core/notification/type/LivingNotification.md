...
**Source:** `org/rusherhack/api/javadoc/core/notification/type/LivingNotification.java`
...
`LivingNotification` is a class that extends [Notification](/api/javadoc/core/notification/type/Notification.md) and implements [ITickable](/api/javadoc/core/interfaces/ITickable.md).
...
| Name | Type | Modifiers |
|------|------|----------|
| timer | [Timer](/api/javadoc/core/utils/Timer.md) | private final |
...
**Returns:** [Timer](/api/javadoc/core/utils/Timer.md)
