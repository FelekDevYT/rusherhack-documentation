...
**Source:** `org/rusherhack/api/javadoc/core/logging/Logger.java`
...
`Logger` is a class and implements [ILogger](/api/javadoc/core/logging/ILogger.md).
...
| parentLogger | [ILogger](/api/javadoc/core/logging/ILogger.md) | private final |
| outputs | [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[ILog](/api/javadoc/core/logging/ILog.md)&gt; | protected final |
