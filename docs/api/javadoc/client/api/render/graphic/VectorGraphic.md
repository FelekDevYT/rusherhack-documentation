...
**Source:** `org/rusherhack/api/javadoc/client/api/render/graphic/VectorGraphic.java`
...
`VectorGraphic` is a class that extends [AbstractGraphic](/api/javadoc/client/api/render/graphic/AbstractGraphic.md).
