...
**Source:** `org/rusherhack/api/javadoc/client/api/render/IRenderer2D.java`
...
`IRenderer2D` is a interface that extends [IScissorable](/api/javadoc/client/api/render/IScissorable.md).
