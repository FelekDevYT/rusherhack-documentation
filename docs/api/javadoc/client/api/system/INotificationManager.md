...
**Source:** `org/rusherhack/api/javadoc/client/api/system/INotificationManager.java`
...
`INotificationManager` is a interface that extends [ILog](/api/javadoc/core/logging/ILog.md).
