...
**Source:** `org/rusherhack/api/javadoc/client/api/system/IRelationManager.java`
...
**Returns:** [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[PlayerRelation](/api/javadoc/client/api/utils/objects/PlayerRelation.md)&gt;
