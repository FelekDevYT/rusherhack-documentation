...
**Source:** `org/rusherhack/api/javadoc/client/api/system/IHudManager.java`
...
`IHudManager` is a interface that extends [IFeatureManager](/api/javadoc/core/feature/IFeatureManager.md).
