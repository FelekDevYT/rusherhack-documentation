...
**Source:** `org/rusherhack/api/javadoc/client/api/system/waypoint/IWaypointManager.java`
...
**Returns:** [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[Waypoint](/api/javadoc/client/api/system/waypoint/Waypoint.md)&gt;
...
**Returns:** [Waypoint](/api/javadoc/client/api/system/waypoint/Waypoint.md)
