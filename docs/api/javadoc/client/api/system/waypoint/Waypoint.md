...
**Source:** `org/rusherhack/api/javadoc/client/api/system/waypoint/Waypoint.java`
...
`Waypoint` is a class and implements [INamed](/api/javadoc/core/interfaces/INamed.md), [JsonSerializable](/api/javadoc/core/serialize/JsonSerializable.md).
...
| pos | `Vec3` | private |
| dimension | [Dimension](/api/javadoc/client/api/utils/objects/Dimension.md) | private |
...
**Returns:** [Dimension](/api/javadoc/client/api/utils/objects/Dimension.md)
