...
**Source:** `org/rusherhack/api/javadoc/client/api/config/Configuration.java`
...
`Configuration` is a class and implements [INamed](/api/javadoc/core/interfaces/INamed.md).
...
| logger | [ILogger](/api/javadoc/core/logging/ILogger.md) | public final |
