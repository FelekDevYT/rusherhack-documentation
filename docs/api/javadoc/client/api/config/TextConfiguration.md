...
**Source:** `org/rusherhack/api/javadoc/client/api/config/TextConfiguration.java`
...
`TextConfiguration` is a class that extends [Configuration](/api/javadoc/client/api/config/Configuration.md).
...
**Returns:** [TextConfiguration](/api/javadoc/client/api/config/TextConfiguration.md)
