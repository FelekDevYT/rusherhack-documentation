...
**Source:** `org/rusherhack/api/javadoc/client/api/feature/window/PopupWindow.java`
...
`PopupWindow` is a class that extends [Window](/api/javadoc/client/api/feature/window/Window.md).
...
| Name | Type | Modifiers |
|------|------|----------|
| content | [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[WindowContent](/api/javadoc/client/api/ui/window/content/WindowContent.md)&gt; | protected final |
| rootView | [WindowView](/api/javadoc/client/api/ui/window/view/WindowView.md) | protected |
