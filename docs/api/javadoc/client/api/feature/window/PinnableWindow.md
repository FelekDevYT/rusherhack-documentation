...
**Source:** `org/rusherhack/api/javadoc/client/api/feature/window/PinnableWindow.java`
...
`PinnableWindow` is a class that extends [Window](/api/javadoc/client/api/feature/window/Window.md) and implements [IPinnable](/api/javadoc/core/interfaces/IPinnable.md).
