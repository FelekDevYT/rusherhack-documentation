...
**Source:** `org/rusherhack/api/javadoc/client/api/feature/module/ToggleableModule.java`
...
`ToggleableModule` is a class that extends [Module](/api/javadoc/client/api/feature/module/Module.md) and implements [IToggleable](/api/javadoc/core/interfaces/IToggleable.md), [IBindable](/api/javadoc/core/bind/IBindable.md).
