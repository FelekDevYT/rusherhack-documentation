...
**Source:** `org/rusherhack/api/javadoc/client/api/feature/module/Module.java`
...
`Module` is a class and implements [IModule](/api/javadoc/client/api/feature/module/IModule.md), `EventListener`, [ILoggable](/api/javadoc/core/logging/ILoggable.md), [Globals](/api/javadoc/client/api/Globals.md).
...
| category | [ModuleCategory](/api/javadoc/client/api/feature/module/ModuleCategory.md) | private final |
