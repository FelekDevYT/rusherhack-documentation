...
**Source:** `org/rusherhack/api/javadoc/client/api/feature/hud/ResizeableHudElement.java`
...
`ResizeableHudElement` is a class that extends [HudElement](/api/javadoc/client/api/feature/hud/HudElement.md).
...
| scale | [NumberSetting](/api/javadoc/core/setting/NumberSetting.md)&lt;[Double](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/lang/Double.html)&gt; | protected final |
