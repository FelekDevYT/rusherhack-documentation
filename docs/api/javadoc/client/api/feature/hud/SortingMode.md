...
| Name | Type | Modifiers |
|------|------|----------|
| comparator | [Comparator](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/Comparator.html)&lt;[ListItem](/api/javadoc/client/api/feature/hud/ListItem.md)&gt; | public final |
