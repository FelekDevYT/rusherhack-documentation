...
**Source:** `org/rusherhack/api/javadoc/client/api/feature/hud/HudElement.java`

A hud element is a draggable [ElementBase](/api/javadoc/client/api/ui/ElementBase.md) that can be rendered on the screen.
...
| snapPoint | [SnapPoint](/api/javadoc/client/api/feature/hud/SnapPoint.md) | protected |
| alignment | [Alignment](/api/javadoc/client/api/feature/hud/Alignment.md) | protected |
...
**Returns:** [SnapPoint](/api/javadoc/client/api/feature/hud/SnapPoint.md)
...
**Returns:** [Alignment](/api/javadoc/client/api/feature/hud/Alignment.md)
