...
**Source:** `org/rusherhack/api/javadoc/client/api/accessors/entity/IMixinLivingEntity.java`
...
```java
 int invokeCalculateFallDamage(double fallDistance, float damageMultiplier)
```
