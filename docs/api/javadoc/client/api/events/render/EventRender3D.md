...
**Source:** `org/rusherhack/api/javadoc/client/api/events/render/EventRender3D.java`
...
`EventRender3D` is a class that extends [EventRender](/api/javadoc/client/api/events/render/EventRender.md).
...
| Name | Type | Modifiers |
|------|------|----------|
| renderer | [IRenderer3D](/api/javadoc/client/api/render/IRenderer3D.md) | private final |
