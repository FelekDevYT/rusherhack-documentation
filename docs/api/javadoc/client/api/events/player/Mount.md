...
**Source:** `org/rusherhack/api/javadoc/client/api/events/player/EventMove.java`

This event is called when an entity carrying the player is moving

## Overview

`Mount` is a class that extends [EventMove](/api/javadoc/client/api/events/player/EventMove.md).
