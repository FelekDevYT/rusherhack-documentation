...
**Source:** `org/rusherhack/api/javadoc/client/api/events/api/javadoc/client/internal/EventNotification.java`
...
| Name | Type | Modifiers |
|------|------|----------|
| type | [NotificationType](/api/javadoc/core/notification/NotificationType.md) | private final |
...
**Returns:** [NotificationType](/api/javadoc/core/notification/NotificationType.md)
