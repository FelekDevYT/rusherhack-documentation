...
**Source:** `org/rusherhack/api/javadoc/client/api/events/world/EventEntity.java`

## Overview

`Remove` is a class that extends [EventEntity](/api/javadoc/client/api/events/world/EventEntity.md).
