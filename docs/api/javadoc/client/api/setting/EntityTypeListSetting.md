...
**Source:** `org/rusherhack/api/javadoc/client/api/setting/EntityTypeListSetting.java`
...
`EntityTypeListSetting` is a class that extends [ListSetting](/api/javadoc/core/setting/ListSetting.md).
