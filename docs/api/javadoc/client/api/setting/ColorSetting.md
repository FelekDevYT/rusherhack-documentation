...
**Source:** `org/rusherhack/api/javadoc/client/api/setting/ColorSetting.java`
...
`ColorSetting` is a class that extends [Setting](/api/javadoc/core/setting/Setting.md).
...
| rainbowMode | [RainbowMode](/api/javadoc/client/api/setting/RainbowMode.md) | private |
...
**Returns:** [RainbowMode](/api/javadoc/client/api/setting/RainbowMode.md)
