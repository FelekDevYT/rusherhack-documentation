...
**Source:** `org/rusherhack/api/javadoc/client/api/setting/ModeSetting.java`
...
`ModeSetting` is a class that extends [OptionSetting](/api/javadoc/core/setting/OptionSetting.md).
...
**Returns:** [ModeSetting](/api/javadoc/client/api/setting/ModeSetting.md)&lt;`T`&gt;
