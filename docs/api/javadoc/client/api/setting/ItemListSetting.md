...
**Source:** `org/rusherhack/api/javadoc/client/api/setting/ItemListSetting.java`
...
`ItemListSetting` is a class that extends [ListSetting](/api/javadoc/core/setting/ListSetting.md).
