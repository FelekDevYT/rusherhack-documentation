...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/panel/PanelHandlerBase.java`
...
`PanelHandlerBase` is a class that extends [ElementHandlerBase](/api/javadoc/client/api/ui/ElementHandlerBase.md).
