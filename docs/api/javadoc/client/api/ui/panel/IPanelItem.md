...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/panel/IPanelItem.java`

TODO: is this even needed

## Overview

`IPanelItem` is a interface that extends [IRenderable2D](/api/javadoc/client/api/render/IRenderable2D.md), [IClickable](/api/javadoc/core/interfaces/IClickable.md), [ITypeable](/api/javadoc/core/interfaces/ITypeable.md).
