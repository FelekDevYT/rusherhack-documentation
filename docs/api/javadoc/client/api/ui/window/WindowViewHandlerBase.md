...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/window/WindowViewHandlerBase.java`
...
| Name | Type | Modifiers |
|------|------|----------|
| windowHandler | [WindowHandlerBase](/api/javadoc/client/api/ui/window/WindowHandlerBase.md) | protected final |
...
Wrapper for [WindowView](/api/javadoc/client/api/ui/window/view/WindowView.md)#renderViewContent(double, double) so custom things can be added
