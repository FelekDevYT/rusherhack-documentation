...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/window/view/ListView.java`
...
`ListView` is a class that extends [WindowView](/api/javadoc/client/api/ui/window/view/WindowView.md).
...
| Name | Type | Modifiers |
|------|------|----------|
| itemView | [ListItemView](/api/javadoc/client/api/ui/window/view/ListItemView.md) | protected final |
| items | [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;`T`&gt; | protected final |
| columns | [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[Column](/api/javadoc/client/api/ui/window/view/Column.md)&gt; | protected final |
| sortColumn | [Column](/api/javadoc/client/api/ui/window/view/Column.md) | protected |
...
**Returns:** [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[Column](/api/javadoc/client/api/ui/window/view/Column.md)&gt;
...
**Returns:** [Column](/api/javadoc/client/api/ui/window/view/Column.md)
...
**Returns:** [ListItemView](/api/javadoc/client/api/ui/window/view/ListItemView.md)
