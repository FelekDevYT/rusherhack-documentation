...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/window/view/ScrollableView.java`

## Overview

`ScrollableView` is a class that extends [SimpleView](/api/javadoc/client/api/ui/window/view/SimpleView.md).
...
| scrollbar | [Scrollbar](/api/javadoc/client/api/utils/objects/Scrollbar.md) | protected final |
...
**Returns:** [Scrollbar](/api/javadoc/client/api/utils/objects/Scrollbar.md)
