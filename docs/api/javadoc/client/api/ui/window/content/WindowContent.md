...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/window/content/WindowContent.java`
...
`WindowContent` is a class and implements [IClickable](/api/javadoc/core/interfaces/IClickable.md), [ITypeable](/api/javadoc/core/interfaces/ITypeable.md), [IScrollable](/api/javadoc/core/interfaces/IScrollable.md), [ITickable](/api/javadoc/core/interfaces/ITickable.md).
...
| Name | Type | Modifiers |
|------|------|----------|
| window | [Window](/api/javadoc/client/api/feature/window/Window.md) | protected final |
...
| contextMenu | [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[ContextAction](/api/javadoc/client/api/ui/window/context/ContextAction.md)&gt; | protected |
...
**Returns:** [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[ContextAction](/api/javadoc/client/api/ui/window/context/ContextAction.md)&gt;
