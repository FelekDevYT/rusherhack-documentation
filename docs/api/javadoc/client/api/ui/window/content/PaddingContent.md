...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/window/content/PaddingContent.java`
...
`PaddingContent` is a class that extends [WindowContent](/api/javadoc/client/api/ui/window/content/WindowContent.md).
