...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/window/content/component/TextComponent.java`
...
`TextComponent` is a class that extends [WindowContent](/api/javadoc/client/api/ui/window/content/WindowContent.md).
