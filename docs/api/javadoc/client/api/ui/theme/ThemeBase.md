...
**Source:** `org/rusherhack/api/javadoc/client/api/ui/theme/ThemeBase.java`
...
`ThemeBase` is a class and implements [ITheme](/api/javadoc/client/api/ui/theme/ITheme.md).
