...
**Source:** `org/rusherhack/api/javadoc/client/api/utils/RotationUtils.java`
...
`RotationUtils` is a class and implements [Globals](/api/javadoc/client/api/Globals.md).
