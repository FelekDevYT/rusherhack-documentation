...
**Source:** `org/rusherhack/api/javadoc/client/api/utils/InventoryUtils.java`
...
`InventoryUtils` is a class and implements [Globals](/api/javadoc/client/api/Globals.md).
