...
**Source:** `org/rusherhack/api/javadoc/client/api/utils/PlayerUtils.java`
...
`PlayerUtils` is a class and implements [Globals](/api/javadoc/client/api/Globals.md).
...
**Returns:** [PlayerInput](/api/javadoc/client/api/utils/objects/PlayerInput.md)
...
@deprecated use [PlayerInput](/api/javadoc/client/api/utils/objects/PlayerInput.md)#hasHorizontalInput()
