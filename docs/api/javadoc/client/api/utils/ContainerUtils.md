...
**Source:** `org/rusherhack/api/javadoc/client/api/utils/ContainerUtils.java`
...
`ContainerUtils` is a class and implements [Globals](/api/javadoc/client/api/Globals.md).
