...
**Source:** `org/rusherhack/client/api/events/network/EventPlayerConnection.java`
...
| Name | Type | Modifiers |
|------|------|----------|
| action | [Action](/client/api/events/network/Action.md) | private final |
...
**Returns:** [Action](/client/api/events/network/Action.md)
