...
**Source:** `org/rusherhack/client/api/events/internal/EventKeybindPress.java`
...
| Name | Type | Modifiers |
|------|------|----------|
| type | [Type](/client/api/events/internal/Type.md) | private final |
...
**Returns:** [Type](/client/api/events/internal/Type.md)
