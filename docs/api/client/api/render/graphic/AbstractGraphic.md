...
**Source:** `org/rusherhack/client/api/render/graphic/AbstractGraphic.java`
...
`AbstractGraphic` is a class and implements [IGraphic](/client/api/render/graphic/IGraphic.md).
