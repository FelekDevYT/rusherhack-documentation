...
| parent | [AbstractCommand](/core/command/AbstractCommand.md) | private final |
| subCommands | [List](https://docs.oracle.com/en/java/javase/21/docs/api/java.base/java/util/List.html)&lt;[AbstractCommand](/core/command/AbstractCommand.md)&gt; | private final |
