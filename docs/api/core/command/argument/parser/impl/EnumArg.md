...
**Source:** `org/rusherhack/core/command/argument/parser/impl/EnumArg.java`
...
`EnumArg` is a class and implements [IArg](/core/command/argument/parser/IArg.md).
...
```java
public T parse(CommandProcessingSink context, String arg)
```
